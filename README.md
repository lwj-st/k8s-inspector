...
docs/v1.4.0/                 v1.4.0 PRD 和阶段验收文档
examples/                     模板与白名单示例
```
...
v1.2.0 发布验收状态见 [v1.2.0 验收报告](docs/v1.2.0/acceptance-report.md)。v1.3.0 发布验收状态见 [v1.3.0 验收报告](docs/v1.3.0/acceptance-report.md)，需求口径见 [v1.3.0 PRD](docs/v1.3.0/prd.md)。v1.4.0 规划见 [v1.4.0 PRD](docs/v1.4.0/prd.md)。
